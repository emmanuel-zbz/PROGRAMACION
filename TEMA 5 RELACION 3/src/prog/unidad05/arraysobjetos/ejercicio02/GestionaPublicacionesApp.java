...
public class GestionaPublicacionesApp {
  ...
  private int imprimeMenu() {
    imprimeTitulo("Gestion de Publicaciones");
    ...
    System.out.println("(4) Buscar publicacion por año de publicacion");
  ...
  private void mostrarPublicacion() {
    imprimeTitulo("mostrar publicaciones");
    for (int i = 0; i < publicaciones.length; i++) {
      System.out.printf("Titulo: %s, Autor: %s, Año publicacion: %d%n", publicaciones[i].getTitulo(), publicaciones[i].getAutor(), publicaciones[i].getAnyoPublicacion());
    }
